...
namespace Metrix.Core.BacklogItem
{
    ...
    {
        public IEnumerable<XyValue<DateTime, int>> CalculateOpenedStoryChart(IEnumerable<Story> stories)
        {
            var graph = stories?
        ...
        public IEnumerable<XyValue<DateTime, int>> CalculateCumulatedOpenedStoryChart(IEnumerable<Story> stories, bool tillToday = true)
        {
            var graph = stories?
                .OrderBy(s => s.CreatedAt)
                .Aggregate(
        ...
        public IEnumerable<XyValue<DateTime, int>> CalculateClosedStoryChart(IEnumerable<Story> stories)
        {
            var graph = stories?
        ...
        public IEnumerable<XyValue<DateTime, int>> CalculateCumulatedClosedStoryChart(IEnumerable<Story> stories, bool tillToday = true)
        {
            var graph = stories?
                .Where(s => s.ClosedAt != null)
                .OrderBy(s => s.ClosedAt)
