...
namespace Io.Juenger.Scrum.GitLab.Repositories
{
    internal class SprintRepository : ISprintRepository
    {
        ...
        public async Task<Sprint> LoadSprintByIdAsync(
            string projectId, 
            int sprintId,
            CancellationToken ct = default)
        {
            ...
            var sprintAggregate = new Sprint(projectId, sprintLabel.Id, sprintLabel.Name, start, end);
        ...
        public async Task<IReadOnlyList<Sprint>> LoadSprintsAsync(
            string projectId, 
            CancellationToken ct = default)
        {
            if (string.IsNullOrWhiteSpace(projectId))
            ...
            var sprintAggregates = new List<Sprint>();
        ...
        public async Task<Sprint> LoadLatestSprintAsync(
            string projectId, 
            CancellationToken ct = default)
        {
