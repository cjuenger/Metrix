...
internal class ProductRepository : IProductRepository
{
    ...
    public async Task<IEnumerable<Product>> LoadProductsAsync(CancellationToken cancellationToken = default)
    {
    ...
    private Product CreateProductAggregate(Project project)
    {
